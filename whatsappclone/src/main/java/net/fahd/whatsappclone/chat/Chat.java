...
import net.fahd.whatsappclone.message.Message;
import net.fahd.whatsappclone.message.MessageConstant;
import net.fahd.whatsappclone.message.MessageState;
import net.fahd.whatsappclone.message.MessageType;
import net.fahd.whatsappclone.user.User;
...
public class Chat extends BaseAuditingEntity {
    ...
    @Transient
    public String getLatsMessage(final String senderId){
